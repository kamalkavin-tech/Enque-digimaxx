...
html = html
  ...
  .replace('</head>', '    <link rel="stylesheet" href="/bluecolorsite/assets/enque-experience.css?v=13">\n    <script src="/bluecolorsite/assets/enque-template-content.js?v=13" defer></script>\n  </head>');
