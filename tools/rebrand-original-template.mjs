...
html = html
  ...
  .replace('</head>', '    <link rel="stylesheet" href="/bluecolorsite/assets/enque-experience.css?v=10">\n    <script src="/bluecolorsite/assets/enque-template-content.js?v=10" defer></script>\n  </head>');
