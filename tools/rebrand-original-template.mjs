...
html = html
  ...
  .replace('</head>', '    <link rel="stylesheet" href="/bluecolorsite/assets/enque-experience.css?v=12">\n    <script src="/bluecolorsite/assets/enque-template-content.js?v=12" defer></script>\n  </head>');
