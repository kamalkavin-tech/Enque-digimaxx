...
html = html
  ...
  .replace('</head>', '    <link rel="stylesheet" href="/bluecolorsite/assets/enque-experience.css?v=14">\n    <script src="/bluecolorsite/assets/enque-template-content.js?v=14" defer></script>\n  </head>');
